...
RUN apt-get update && apt-get install -y postgresql-client-11 postgresql-common postgresql-11 postgresql-11-postgis-2.5 postgresql-11-pgrouting netcat postgresql-11-ogr-fdw python3 vim git python3-pip python3-venv && rm -rf /var/lib/apt/lists/* && apt-get update
